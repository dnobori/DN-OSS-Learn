...
namespace IPA.DN.CoreUtil.Basic
{
    ...
    public class ZipPacker
    {
        ...
        class File
        {
            ...
            public CoreUtil.Basic.Internal.ZStream ZStream;
        ...
        public void AddFileStart(string name, long size, DateTime dt, FileAttributes attribute, bool compress)
        {
            ...
            if (compress)
            {
                f.ZStream = new CoreUtil.Basic.Internal.ZStream();
        ...
        public long AddFileData(byte[] data, int pos, int len)
        {
            ...
            {
                CoreUtil.Basic.Internal.ZStream zs = currentFile.ZStream;
                ...
                {
                    zs.deflate(CoreUtil.Basic.Internal.zlibConst.Z_FINISH);
                }
                else
                {
                    zs.deflate(CoreUtil.Basic.Internal.zlibConst.Z_SYNC_FLUSH);
                }
