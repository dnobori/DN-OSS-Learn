...
unless (caller) {
    ...
    use lib 'C:/git/SE-Build-crosslib_win32_v2/OpenSSL/src/build/vc2019/Win32_Debug/util/perl';
    use OpenSSL::fallback 'C:/git/SE-Build-crosslib_win32_v2/OpenSSL/src/build/vc2019/Win32_Debug/external/perl/MODULES.txt';
    ...
    if (scalar @ARGV == 0) {
        ...
        use lib '.';
        use lib 'C:/git/SE-Build-crosslib_win32_v2/OpenSSL/src/build/vc2019/Win32_Debug/Configurations';
        use gentemplate;
